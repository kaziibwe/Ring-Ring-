                                ...
                                <div class="product-item bg-light mb-4">
                                    ...
                                    <div class="product-img position-relative overflow-hidden">
                                        ...
                                        {{-- <div class="product-action">
                                            <a class="btn btn-outline-dark btn-square open-size-modal"
                                        ...
                                        @if ($product->discount > 0)
                                            ...
                                            <div class="d-flex align-items-center justify-content-center mt-2">
                                                ...
                                                <h6 class="text-muted ml-2">
                                                    <del>Sh{{ number_format($product->price, 2) }}</del></h6>
                                            </div>
                                        @else
                                            @if ($product->price)
                                                <a class="h6 text-decoration-none text-truncate"
            ...
            <div class="col-12">
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center">
                        <li class="page-item {{ !$shopProducts->onFirstPage() ? '' : 'disabled' }}">
                            <a class="page-link" href="{{ $shopProducts->previousPageUrl() }}"
                                aria-label="Previous">
                                <span aria-hidden="true">&laquo;</span>
                            </a>
                        </li>
                        <!-- Loop through the available pages -->
                        @for ($i = 1; $i <= $shopProducts->lastPage(); $i++)
                            <li class="page-item {{ $shopProducts->currentPage() == $i ? 'active' : '' }}">
                                <a class="page-link" href="{{ $shopProducts->url($i) }}">{{ $i }}</a>
                            </li>
                        @endfor
                        <li class="page-item {{ $shopProducts->hasMorePages() ? '' : 'disabled' }}">
                            <a class="page-link" href="{{ $shopProducts->nextPageUrl() }}" aria-label="Next">
