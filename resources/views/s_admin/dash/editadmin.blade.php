    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{ route('dash.manageadmin') }}">Manage Admin</a></li>
                    ...
                    <div class="col-lg-8 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="d-flex justify-content-center py-4">
                            <a href="index.html" class="logo d-flex align-items-center w-auto">
                                ...
                                <span class="d-none d-lg-block">Edit Acount for Admin</span>
                            </a>
                        </div><!-- End Logo -->
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <form class="row g-3 needs-validation" action="{{ route('dashboard.authenticate') }}"
                                    novalidate method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="col-12">
                                        <label for="yourName" class="form-label"> Fullname</label>
                                        <input type="text" name="name" class="form-control"
                                        value="{{ $admin->name }}" id="yourName" required>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="col-md-8 col-lg-9">
                                                <img src="{{ $admin->image ? asset('storage/' . $admin->image) : asset('../assets/img/profile-img.jpg') }}"
                                    ...
                                    <div class="col-12">
                                        ...
                                        value="{{ $admin->email }}" id="yourEmail" required>
                                    ...
                                    <div class="col-12">
                                        ...
                                        value="{{ $admin->number }}" id="yourEmail" required>
                                    ...
                                    <div class="col-12">
                                        ...
                                        value="{{ $admin->NIN }}" id="yourEmail" required>
                                    ...
                                    <div class="col-12">
                                        ...
                                        value="{{ $admin->street }}" id="yourEmail" required>
                                    ...
                                    <div class="col-12">
                                        ...
                                        value="{{ $admin->division }}" id="yourEmail" required>
                                    ...
                                    <div class="col-12">
                                        ...
                                        value="{{ $admin->country }}" id="yourEmail" required>
