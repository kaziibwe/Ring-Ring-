    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{ route('dashboard.manageorder') }}">Manage Orders</a></li>
            ...
            <div class="col-lg-12 ">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <p><Strong>Location</Strong> : <b>City--</b>{{ $order->city }}, <b>Division</b>
                                {{ $order->division }}, <b>Street</b> {{ $order->street }}</p>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p> <strong> Shipping</strong>:Sh{{ number_format($order->shipping_fee, 2, '.', ',') }}</p>
                        </li>
