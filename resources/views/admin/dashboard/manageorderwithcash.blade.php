<x-layout_admin>
    <div class="pagetitle">
        <h1> Orders With Cash</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('dashboard.index') }}">Home</a></li>
                <li class="breadcrumb-item"> Orders & Payments </li>
                <li class="breadcrumb-item active"> Orders With Cash</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Manage Order with cash</h5>
                        ...
                        @foreach ($orders as $order)
                            <tr>
                                ...
                                <td> <button type="button" class="btn btn-success"
                                        onclick="window.location.href = '{{ route('dashboard.manageorderdetail', ['order' => $order->id]) }}'">View</button>
                                </td>
