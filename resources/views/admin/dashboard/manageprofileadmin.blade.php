            ...
            <div class="col-xl-4">
                ...
                <div class="card">
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        ...
                        <img src="{{ auth('admin')->user()->image ? asset('storage/' . auth('admin')->user()->image) : asset('../assets/img/profile-img.jpg') }}" alt="Profile" class="rounded-circle">
                    ...
                    <div class="card-body pt-3">
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <p class="small fst-italic">{{ auth('admin')->user()->description }}.</p>

                                <h5 class="card-title">Profile Details</h5>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label ">Full Name</div>
                                    <div class="col-lg-9 col-md-8">{{ auth('admin')->user()->name }}</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Company</div>
                                    <div class="col-lg-9 col-md-8">{{ auth('admin')->user()->company }}</div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">{{ auth('admin')->user()->NIN }}</div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Country</div>
                                    <div class="col-lg-9 col-md-8">{{ auth('admin')->user()->country }}</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Address</div>
                                    <div class="col-lg-9 col-md-8">{{ auth('admin')->user()->street }}, {{ auth('admin')->user()->division }},{{ auth('admin')->user()->city }}</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Phone No</div>
                                    <div class="col-lg-9 col-md-8">{{ auth('admin')->user()->number }}</div>
                                </div>
                                <div class="row">
                                ...
                                <form action="{{ route('dashboard.updateadminprofile') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <img src="{{ auth('admin')->user()->image ? asset('storage/' . auth('admin')->user()->image) : asset('../assets/img/profile-img.jpg') }}" alt="Profile">
                                            {{-- <div class="pt-2">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <textarea name="description" class="form-control" id="about" style="height: 100px">{{ auth('admin')->user()->description }}.</textarea>
                                        </div>
                                        @error('description')
                                        <code>{{ $message }}</code>
                                    @enderror
                                    ...
                                    @enderror
                                     ...
                                     <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="email" type="email" class="form-control" id="Job"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="number" type="text" class="form-control" id="Job"
                                            value="{{ auth('admin')->user()->number }}">
                                        </div>
                                        @error('email')
                                        <code>{{ $message }}</code>
                                    @enderror
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            ...
                                            value="{{ auth('admin')->user()->division }}">
                                        </div>
                                        @error('division')
                                        <code>{{ $message }}</code>
                                    @enderror
                            ...
                            <div class="tab-pane fade pt-3" id="profile-change-password">
                                ...
                                <form action="{{ route('dashboard.changepasswordadmin') }}" method="POST">
                                    @csrf
