                    ...
                    <div class="col-lg-8 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="d-flex justify-content-center py-4">
                            <a href="index.html" class="logo d-flex align-items-center w-auto">
                                ...
                                <span class="d-none d-lg-block">Create Account for Supplier Manager</span>
                            </a>
                        </div><!-- End Logo -->
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="pt-4 pb-2">
                                    ...
                                    <p class="text-center small">Enter your Supplier details to create account</p>
                                </div>

                                <form class="row g-3 needs-validation" action="{{ route('dashboard.supplierregistering') }}" novalidate  method="POST"
                                ...
                                @csrf
                                    ...
                                    <div class="col-12">
                                        <label for="yourEmail" class="form-label">Product </label>
                                        <input type="text" name="product" class="form-control" value="{{ old('product') }}" id="yourEmail"
                                            required>
